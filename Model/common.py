...
class TrunkBranch(nn.Module):
    def __init__(
        ...
        modules_body = []
        for i in range(2):
            modules_body.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
...
class MaskBranchDownUp(nn.Module):
    def __init__(
        ...
        MB_RB1 = []
        MB_RB1.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
        ...
        MB_RB2 = []
        for i in range(2):
            MB_RB2.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
         
        MB_Up = []
        MB_Up.append(nn.ConvTranspose2d(n_feat,n_feat, 6, stride=2, padding=2))   
        
        MB_RB3 = []
        MB_RB3.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
...
class ResAttModuleDownUpPlus(nn.Module):
    def __init__(
        ...
        RA_RB1 = []
        RA_RB1.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
        RA_TB = []
        RA_TB.append(TrunkBranch(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
        RA_MB = []
        RA_MB.append(MaskBranchDownUp(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
        RA_tail = []
        for i in range(2):
            RA_tail.append(ResBlock(conv, n_feat, kernel_size, bias=True, bn=False, act=nn.LeakyReLU(0.1, inplace=True), res_scale=1))
