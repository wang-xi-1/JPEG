...
def main():
    ...
    testset_name = 'BSDS500_color' # 'LIVE1_color' 'Classic5' 'BSDS500_color'
    n_channels = 3           # set 1 for grayscale image, set 3 for color image
    model_name = 'deblock_color.pth'
    ...
    for quality_factor in quality_factor_list:
        ...
        from Model_C.network_deblocker import DeblockNet as net
        model = net()
